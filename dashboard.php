...
<br>
  <div class="w3-row">
    ...
    <div class="w3-col m8">
	  ...
	  <div id="maincont" class="cont1">
	  <br>
		<h2>IMPORTANT OMs/NOTIFICATIONS</h2><!--<p class="br"></p>--->
<li class="ccpd_bg"><a href="position.pdf"  target="_blank" title="PDF file that opens in a new window " >List of identified jobs for Persons with Disabilities - 2018 <span class="hidethis"> (PDF file that opens in a new window)</span><img class="pdf_icon" src="pdf_icon.gif" border="0" alt=""></a></li>

<p class="br"></p>
<h2>EMPLOYMENT</h2>
<li class="ccpd_bg"><a href="file2.pdf" target="_blank" title="PDF file that opens in a new window">Special Recruitment Drive to fill up the vacancies for Persons with Disabilities - 25.05.2015<span class="hidethis"> (PDF file that opens in a new window)</span><img class="pdf_icon" src="pdf_icon.gif" border="0" alt=""></a></li>
<li class="ccpd_bg"><a href="file3.pdf" target="_blank" title="PDF file that opens in a new window">Reservation for persons with disabilities - Computation of reservation- implementation of the judgement of Honable Supreme Court in the matter of Union of India and Anr. Vs. National Federation of Blind and Ors - 03.12.2013 and 29.12.2015<span class="hidethis"> (PDF file that opens in a new window)</span><img class="pdf_icon" src="pdf_icon.gif" border="0" alt=""></a></li>

<li class="ccpd_bg"><a href="file4.pdf" target="_blank" title="PDF file that opens in a new window">Judgement of the High Court of Delhi in W.P. (C) No. 15828/2006 National Federation of Blind Vs. UOI &amp; Ors.-reg (356 KB)<span class="hidethis"> (PDF file that opens in a new window)</span><img class="pdf_icon" src="pdf_icon.gif" border="0" alt=""></a></li>
<p class="br"></p>
<h2>TRANSFER/POSTING</h2><li class="ccpd_bg"><a href="file5.pdf" target="_blank" title="PDF file that opens in a new window">Posting of Government employees who have differently abled dependents - 05.01.2016<span class="hidethis"> (PDF file that opens in a new window)</span><img class="pdf_icon" src="pdf_icon.gif" border="0" alt=""></a></li>
<p class="br"></p>
<h2>TRANSPORT ALLOWANCE</h2>
<li class="ccpd_bg"><a href="file6.pdf" target="_blank" title="PDF file that opens in a new window">Travelling Allowance i.r.o. Attendant/Escort for accompanying a Government Servant with disabilities on travel during tour/training etc. - 17.02.2015 <span class="hidethis"> (PDF file that opens in a new window)</span><img class="pdf_icon" src="pdf_icon.gif" border="0" alt=""></a></li>
<p class="br"></p>
...
// Create connection
$conn = new mysqli("localhost", "root","", "silenthorn");
// Check connection
if ($conn->connect_error) {
    die("Connection failed: " . $conn->connect_error);
} 
$name = $username = $email = $dob = $password = $physicallychallenged = $comment = $schemes = $address = $city = $state = $phonenumber = $gender = $occupation = "";
...
if(isset($_POST['type'])){
	$physicallychallenged = $_POST['type'];	
}
...
if(isset($_POST['option3'])){
	$occupation = $_POST['option3'];
}
if(isset($_POST['submit']))
{
$sql =  "INSERT INTO user (user_id, name, email, dob, password, physicallychallenged, comment, schemes, address, city, state, phonenumber, occupation,username,gender) VALUES (NULL, '$name', '$email', '$dob', '$password', '$physicallychallenged', '$comment', '$schemes', '$address', '$city', '$state', '$phonenumber', '$occupation','$username','$gender')";
