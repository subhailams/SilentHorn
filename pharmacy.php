...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `users` WHERE CONCAT(`id`, `medicine`, `pharmacy`, `address`) LIKE '%".$valueToSearch."%'";
...
{
    $connect = mysqli_connect("localhost", "root", "", "silenthorn");
...
<!-- Header -->
  ...
  <div  class="w3-container w3-card w3-white w3-round w3-margin">
    ...
    <form action="pharmacy.php" method="post">
            <input type="text" name="valueToSearch" placeholder="Enter your medicine name"><br><br>
