...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
  ...
  <a href="acts.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-black" title="Acts"><i class="fa fa-bn fa-fw"></i>Acts</a>
  ...
  <div class="w3-row">
    ...
    <div class="w3-col m8">
      ...
      <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
        ...
        <h4>DR.John Doe</h4><br>
		<p>MBBS, MD - General Medicine</p> <p>DM - CardiologyCardiologist</p> <p>33 Years Experience</p>
		<button type="button" class="w3-button w3-theme-d1 w3-margin-bottom"><i class="fa fa-feed"></i>  Contact</button> 
        <button type="button" class="w3-button w3-theme-d2 w3-margin-bottom"><i class="fa fa-handshake-o"></i>  Appointment</button> 
		
        <hr class="w3-clear">
        <p>Dr. K Narasimha Reddy is a Cardiologist in Vanagaram, Chennai and has an experience of 33 years in this field. Dr. K Narasimha Reddy practices at Apollo Speciality Hospital in Vanagaram, Chennai. He completed MBBS from Sri Venkateswara Medical College, Tirupathi Sri venkateswara University in 1971,MD - General Medicine from Stanely Medical College,Madras University in 1982 and DM - Cardiology from CMC Vellore,Madras University in 1985.
Some of the services provided by the doctor are: Angioplasty,Atrial Fibrillation,Permanent Pacemaker,Balloon Mitral Valvotomy and Treatment Of Arrhythmia etc.</p>
