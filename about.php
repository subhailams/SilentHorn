...
<a href="https://www.instagram.com/" class="fa fa-instagram"></a>
      ...
      <a href="language.php" class="w3-bar-item w3-button w3-padding"> 
...
<!-- Header -->
  ...
  <div class="mySlides w3-display-container w3-center">
    <img src="hope.jpg" style="width:100%" height="500">
    <div class="w3-display-bottommiddle w3-container w3-text-white w3-padding-32 w3-hide-small">
     
      <p><b>Hope is being able to see that there is a light despite all of the darkness!</b></p>   
    </div>
  </div>
  <div class="mySlides w3-display-container w3-center">
    <img src="can.jpg" style="width:100%" height="500">
    <div class="w3-display-bottommiddle w3-container w3-text-white w3-padding-32 w3-hide-small">
      <p><b>Success is not final, failure is not fatal: it is the courage to continue that counts!</b></p>    
    </div>
  </div>
  <div class="mySlides w3-display-container w3-center">
    <img src="care.jpg" style="width:100%" height="500">
    <div class="w3-display-bottommiddle w3-container w3-text-white w3-padding-32 w3-hide-small">
      <p><b>It's all about quality of life and finding a happy balance between work and friends and family!</b></p>    
    </div>
  </div>

  <!-- The Band Section -->
  <div class="w3-container w3-content w3-center w3-padding-64" style="max-width:800px" id="band">
    <h2 class="w3-wide">THE SILENTHORN</h2>
    <p class="w3-opacity"><i>We Can</i></p>
    <p class="w3-justify">Whether you have a disability or not, everyone is welcome to freely browse our site, however, we suggest you familiarize yourself with our website terms and policies, whose links can be found at the bottom of any of our pages, first.
...
People with disabilities are the largest minority group any person can join at any time, and due to accidents and old age eventually do. Disability will affect the lives of everyone during their life, it is time society changed to acknowledge this.</p>
    <p class="w3-justify">As the longest established and most prominent specialist disability website, Disabled United have been bringing members of the disabled community together for more than 15 years. An essential community platform and an indispensable portal of information, Disabled United has become the first port of call - for disabled and able-bodied people alike - when it comes to issues surrounding disability. 
    </p>
Although our online community has grown exponentially since we were established in 2001, the launch of our brand new website takes things to a new, exciting level. As well as all of the features that you've come to know and love, we're launching a few new ones to make the whole experience even more enjoyable, informative, practical and most importantly of all, interactive.
	<div class="w3-row w3-padding-32">
      <div class="w3-third">
        
        <img src="s4.jpg" class="w3-round w3-margin-bottom" alt="Random Name" style="width:60%">
      </div>
      <div class="w3-third">
        
        <img src="s2.jpg" class="w3-round w3-margin-bottom" alt="Random Name" style="width:60%">
      </div>
      <div class="w3-third">
        
        <img src="s3.png" class="w3-round" alt="Random Name" style="width:60%">
      </div>
    </div>
  </div>
